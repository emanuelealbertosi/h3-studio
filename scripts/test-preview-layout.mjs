...
assert.match(page, /deleteTimelineFromLibrary/);
assert.match(page, /key\.startsWith\("timeline:"\)/);
assert.match(page, /Elimina montaggio; conserva i video sorgente/);
...
assert.match(page, /type MediaLibraryCategory = "all" \| "montages" \| "assets" \| "images" \| "external" \| "videos"/);
assert.match(page, /aria-label="Filtra la Libreria per categoria"/);
assert.match(page, /libraryCategoryOptions\.map/);
assert.match(page, /libraryCategory === "all" \|\| libraryCategory === "montages"/);
assert.match(page, /libraryCategory === "all" \|\| libraryCategory === "assets"/);
assert.match(page, /libraryCategory === "all" \|\| libraryCategory === "images"/);
assert.match(page, /libraryCategory === "all" \|\| libraryCategory === "external"/);
assert.match(page, /libraryCategory === "all" \|\| libraryCategory === "videos"/);
assert.match(css, /\.media-library-category-filter\s*\{[^}]*overflow-x:\s*auto/s);
assert.match(css, /\.media-library-category-filter button\.active\s*\{[^}]*color:\s*var\(--accent\)/s);
